...
if { $argc != 11 } {
    puts "ERROR par_proasic.tcl:: 11 arguements need to be passed in"
    exit
} else {
...
import\
    ...
    -edif_flavor "GENERIC" "../syn/rev_proasic/${unit}.edf"\
    -format "sdc" "$phys_dir/constraints/${unit}_proasic_par.sdc"\
    -format "pdc" -abort_on_error "NO" "$phys_dir/constraints/${unit}_proasic_par.pdc"
